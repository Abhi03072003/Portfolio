...
export default function Contact() {
  ...
  const handleDownloadResume = () => {
    ...
    link.download = 'Deepak Maurya Resume';
    link.click();
  };
    ...
    <section id="contact" className="py-20 bg-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p
            className="text-slate-300 mt-6 max-w-2xl mx-auto"
            variants={fadeUp}
            custom={2}
          >
          ...
          <div className="space-y-8">
            {[
                  ...
                  <>
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:deepakm124578@gmail.com" className="text-blue-400 hover:text-blue-300">deepakm124578@gmail.com</a>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4 mt-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-400">+91-9140842300</p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-4 mt-4">
              ...
              },
              {
                ...
                content: (
                  <div className="flex space-x-4">
                    {[
                      { icon: "fab fa-github", href: "https://github.com/dkm4339" },
                      { icon: "fab fa-linkedin", href: "https://linkedin.com/in/dkm4339" },
                      { icon: "fas fa-envelope", href: "mailto:deepakm124578@gmail.com" }
                    ].map((item, i) => (
                      <a
                        key={i}
                        href={item.href}
              ...
              },
              {
                ...
                content: (
                  <>
                    <p className="text-slate-300 mb-4">Get a copy of my resume to learn more about my experience and skills.</p>
                    <button
